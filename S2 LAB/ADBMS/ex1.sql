...
INSERT INTO regions(region_id,region_name) VALUES (4,'Middle East andAfrica');
select * from regions;


#TABLE COUNTRIES VALUES
...
INSERT INTO employees(employee_id,first_name,last_name,email,phone_number,hire_date,job_id,salary,manager_id,department_id) VALUES (102,'Lex','DHaan','lex.de haan@sqltutorial.org','515.123.4569','1993-01-13',5,17000.00,100,9);
...
INSERT INTO employees(employee_id,first_name,last_name,email,phone_number,hire_date,job_id,salary,manager_id,department_id) VALUE(120,'Matthew','Weiss','matthew.weiss@sqltutorial.org','650.123.1234','1996-07-18',19,8000.00,100,5);
...
INSERT INTO employees(employee_id,first_name,last_name,email,phone_number,hire_date,job_id,salary,manager_id,department_id) VALUE(192,'Sarah','Bell','sarah.bell@sqltutorial.org','650.501.1876','1996-02-04',17,4000.00,123,5);
...
select e.first_name,e.last_name as name from employees e join jobs j on e.job_id=j.job_id where job_title='Shipping Clerk';
...
select job_title from jobs where max_salary>2000;
...
desc employees;
insert into employees values(207,'Paul','Newton','paulnew@gmail.com','1234567890','1995-10-31',10,20000,20,11,null);

delete from dept where department_name='Shipping';
set sql_safe_updates=0;

create view demo as select * from employees where employee_id=121;
select * from demo;
drop view demo;
create table demo(id int primary key,name varchar(50),age int,mark1 int,mark2 int);


insert into demo (id,name,age,mark1,mark2) values(1,'A',19,20,20),(2,'B',19,18,19),(3,'C',20,20,15),(4,'D',20,19,10);
select * from demo;
...
create table mark(rollno int primary key,id int,mark1 int,foreign key(id) references student(id));
insert into mark values(1,1,19);
insert into mark values(2,2,20);
insert into mark values(3,3,20);
create view demo as select s.name,m.mark1 from student s join mark m on s.id=m.id where mark1>19;
select * from demo;